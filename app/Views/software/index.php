                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="md-form col-sm-4">
                                <input type="text" id="user_id" name="software_id" class="form-control" readonly value="{{vm.software.software_id}}">
                        ...
                        <div class="row">
                            <div class="md-form col-sm-12">
                                <input type="text" id="name" name="name" maxlength="100" class="form-control" value="{{vm.software.name}}" required>
