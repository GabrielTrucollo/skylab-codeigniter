...
<form method="POST" action="<?= base_url('user/login/password-new') ?>">
    <section class="view">
                        ...
                        <div class="card wow fadeIn" data-wow-delay="0.3s">
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    ...
                                    <h6 class="white-text">Você ainda não possúi uma senha, por favor, preencha o campo a baixo com uma nova senha</h6>
                                </div>

                                <div class="md-form">
                                    <i class="fas fa-lock prefix white-text"></i>
                                    <label for="password">Informe uma senha para os seus acessos</label>
