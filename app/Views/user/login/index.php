                        ...
                        <div class="card wow fadeIn" data-wow-delay="0.3s">
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    ...
                                    <h6 class="white-text">Para continuar informe seus dados de acesso</h6>
                                </div>
                                <div class="md-form">
                                    <i class="fas fa-address-card prefix white-text"></i>
                                    <label for="doc_cpf">Informe seu CPF</label>
                                    <input name="doc_cpf" type="text" id="doc_cpf" class="form-control"  autofocus required>
                                </div>

                                <div class="text-center">
                                    <button class="btn blue-gradient btn-lg">Continuar <i class="fas fa-arrow-right prefix white-text"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
